...
```
### Important note
Even tough the data comes from a reliable source it is outdated (2017) and may not be accurate anymore.
...
Business Majors are the most popular followed by Education and Humanities & Liberal Arts. In the other end are Interdisciplinary, Agriculture & Natural Resources and Law % Puclic Policy majors
...
collegeWomenData %>% 
  ...
  labs(title= "Top 15 STEM majors with the  female percentage") + 
